...
<body>
	...
	<div class="content">
		...
		<div class="set_main">
			<div class="main_hd">
				<h2>
					<a href="${context_path}/security">安全中心</a>&nbsp;&gt;&nbsp;设置分类密码
				</h2>
			</div>
			<div class="main_bd">
				<div class="highlight_box">
					<p class="desc">
						1.为了保证分类密码的安全性，请避免与登录密码相同。<br /> 2.设置了分类密码，您可以创建保密分类，分类中可以收藏私密网址。
					</p>
				</div>
					...
					<div class="setpsw-box">
						<div class="frm_controls">
							...
							<div class="frm_input_box">
								<input id="categorypsw" name="categorypsw" type="password"
									class="frm_input" />
							</div>
						</div>
						<div class="frm_controls">
							...
							<div class="frm_input_box">
								<input id="confirmcategorypsw" name="confirmcategorypsw"
									type="password" class="frm_input" />
							</div>
						</div>
						<div class="frm_controls">
